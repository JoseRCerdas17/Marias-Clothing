      ...
      <main className="pt-16 pb-24">
        ...
        <div className="px-5 py-6 space-y-6">
          <div>
            ...
            <h1 className="text-2xl font-bold text-on-surface mt-1">{product.name}</h1>
            ...
            <div>
              ...
              <div className="flex gap-2 flex-wrap">
                {product.sizes.map((size) => (
                  <button
                    key={size}
                    className="bg-surface-container-high text-on-surface px-4 py-2 rounded-lg text-sm hover:bg-surface-container-highest transition-colors"
                  >
                    {size}
                  </button>
                ))}
          ...
          {product.colors.length > 0 && (
            <div>
              <h3 className="text-sm font-semibold text-on-surface mb-2">Colors</h3>
              <div className="flex gap-2 flex-wrap">
                {product.colors.map((color) => (
                  <span
                    key={color}
                    className="bg-surface-container-high text-on-surface px-4 py-2 rounded-lg text-sm"
                  >
                    {color}
                  </span>
                ))}
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full bg-primary-container text-white py-4 rounded-xl font-semibold active:scale-[0.98] transition-transform"
          >
