        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="p-6 md:p-10 flex flex-col">
            ...
            <div className="mt-auto pt-4 flex flex-col gap-3">
              ...
              {product.is_sold ? (
                <span
                  className="flex w-full cursor-not-allowed items-center justify-center rounded-full border border-white/10 py-4 text-[14px] tracking-[-0.30px] text-iron-gray md:text-[15px]"
                  style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 500 }}
                >
                  Sold
                </span>
